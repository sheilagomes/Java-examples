...
* Eventos - Projeto Spring MVC de um gerenciador de eventos, feito do zero no Spring Tools Suite com Bootstrap. Já tem as views, models e controller prontos, já adiciona ao BD, o modal de exclusão funciona, mas a exclusão e edição ainda não.
